...
module.exports = LiterallyCanvas = (function() {
  function LiterallyCanvas(arg1, arg2) {
    ...
    this.scale = 1.0;
    this.isBlocked = opts.isBlocked || true;
    this.canAdd = opts.canAdd || false;
    this.canEdit = opts.canEdit || false;
    this.userId = opts.userId || false;
    this.is_manager = opts.is_manager || false;
    if (!this.isBlocked) {
  ...
  LiterallyCanvas.prototype.block = function(isBlock, canAdd, canEdit) {
  ...
  LiterallyCanvas.prototype.setUserId = function(userId) {
  ...
  LiterallyCanvas.prototype.setTool = function(tool) {
    ...
    if (this.tool && this.tool.name === tool.name && tool.name === "Comment") {
      ...
      if ((ref2 = this.tool) != null) {
        ref2.willBecomeInactive(this);
      }
    } else {
      this.tool = tool;
      this.manageActiveToolComments();
  ...
  LiterallyCanvas.prototype.setColor = function(name, color, isOwn) {
    if (isOwn == null) {
      isOwn = false;
    }
    ...
    this.trigger(name + "ColorChange", {
      newColor: this.colors[name],
      isOwn: isOwn
    });
    if (name === 'background') {
      return this.trigger("drawingChange");
